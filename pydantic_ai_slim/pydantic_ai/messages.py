...
class ToolCallPart:
    ...
    def has_content(self) -> bool:
        ...
        # For dictionaries and other containers, bool(self.args) is False for empty ones.
        # This matches the intended semantics (ignoring empty dicts/lists; accepting 0, False, etc.)
