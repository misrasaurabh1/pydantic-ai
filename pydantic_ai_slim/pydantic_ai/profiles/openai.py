...
def openai_model_profile(model_name: str) -> ModelProfile:
    ...
    # Reuse the relevant (already-instantiated) profile for improved performance.
    return _is_reasoning_true_profile if is_reasoning_model else _is_reasoning_false_profile
...
_is_reasoning_true_profile = OpenAIModelProfile(
...
_is_reasoning_false_profile = OpenAIModelProfile(
    json_schema_transformer=OpenAIJsonSchemaTransformer,
    supports_json_schema_output=True,
    supports_json_object_output=True,
